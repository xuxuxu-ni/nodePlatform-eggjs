...
const organizeManage = () => import('@/views/systemManage/organizeManage')
const personnelManage = () => import('@/views/systemManage/personnelManage')
const menuManage = () => import('@/views/systemManage/menuManage')
const roleManage = () => import('@/views/systemManage/roleManage')
const jurisdictionManage = () => import('@/views/systemManage/jurisdictionManage')
const codeManage = () => import('@/views/systemManage/codeManage')
const kehujiekuanshengpi = () => import('@/views/business/kehujiekuanshengpi')
const fuyoutuipiaochaxun = () => import('@/views/business/fuyoutuipiaochaxun')
const lenderManage = () => import('@/views/business/lenderManage')
const reduceManage = () => import('@/views/business/reduceManage')
const wxxiaozhangguanli = () => import('@/views/business/wxxiaozhangguanli')
const xiaozhangguanli = () => import('@/views/business/xiaozhangguanli')
const orderInformation = () => import('@/views/business/orderInformation')
const customerInformation = () => import('@/views/business/customerInformation')
const neibujigoupaidan = () => import('@/views/business/neibujigoupaidan')
const cuishouzhuguanpaidan = () => import('@/views/business/cuishouzhuguanpaidan')
const cuishou = () => import('@/views/business/cuishou')
const bannerSetting = () => import('@/views/systemSetting/bannerSetting')
const questionSetting = () => import('@/views/systemSetting/questionSetting')
const agreementSetting = () => import('@/views/systemSetting/agreementSetting')
const noticeSetting = () => import('@/views/systemSetting/noticeSetting')
