...
const en = {
  routeNmae: {
    ...
    jurisdictionManage: "jurisdictionManage",
    parameterManage: "parameterManage",
    codeManage: "codeManage",
    business: "business",
    kehujiekuanshengpi: "kehujiekuanshengpi",
    fuyoutuipiaochaxun: "fuyoutuipiaochaxun",
    lenderManage: "lenderManage",
    reduceManage: "reduceManage",
    wxxiaozhangguanli: "wxxiaozhangguanli",
    xiaozhangguanli: "xiaozhangguanli",
    orderInformation: "orderInformation",
    customerInformation: "customerInformation",
    cuishouguanli: "cuishouguanli",
    neibujigoupaidan: "neibujigoupaidan",
    cuishouzhuguanpaidan: "cuishouzhuguanpaidan",
    cuishou: "cuishou",
